...
interface ReanimatingModalProps {
  isOpen: boolean;
  message: string;
}

const ReanimatingModal: React.FC<ReanimatingModalProps> = ({ isOpen, message }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-xl font-bold text-gray-300 mb-2">{t.reanimatingModalTitle}</h2>
...
export default ReanimatingModal;
